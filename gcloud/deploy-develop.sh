...
# Colocar um docker file para prd para fazer com -f (duvida)
...
kubectl set image deployment/${APP_DEPLOYMENT} ${APP_CONTAINER}=gcr.io/${PROJECT_DEV}/${IMAGE_NAME}:${TRAVIS_COMMIT}